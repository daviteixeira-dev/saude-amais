...
export class CreateTables1640308389068 implements MigrationInterface {
    name = 'CreateTables1640308389068'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."system_user_type_enum" AS ENUM('student', 'teacher', 'admin')`);
        await queryRunner.query(`CREATE TABLE "system_user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "lastname" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "cpf" character varying NOT NULL, "birth_date" TIMESTAMP NOT NULL, "address" character varying NOT NULL, "type" "public"."system_user_type_enum" NOT NULL, "created_At" TIMESTAMP NOT NULL DEFAULT now(), "updated_At" TIMESTAMP NOT NULL DEFAULT now(), "locationId" uuid, CONSTRAINT "REL_935356e6561538544baa6bc2c6" UNIQUE ("locationId"), CONSTRAINT "PK_9949334be1756656fab9fac4a0c" PRIMARY KEY ("id"))`);
